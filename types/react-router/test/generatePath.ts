...
generatePath('/posts/:postId', { postId: ['1'] }); // $ExpectError
generatePath('/posts/:postId+', { postId: [] }); // $ExpectError
generatePath('/posts/:postId?', { postId: ['1'] }); // $ExpectError
...
generatePath('/posts/:postId+', { postId: '1' });
generatePath('/posts/:postId+', { postId: ['1'] });
generatePath('/posts/:postId+', { postId: ['1', 1, true] });
generatePath('/posts/:postId?', {});
generatePath('/posts/:postId?', { postId: '1' });
generatePath('/posts/:postId*', {});
generatePath('/posts/:postId*', { postId: '1' });
generatePath('/posts/:postId*', { postId: [] });
generatePath('/posts/:postId*', { postId: ['1', 1, true] });
